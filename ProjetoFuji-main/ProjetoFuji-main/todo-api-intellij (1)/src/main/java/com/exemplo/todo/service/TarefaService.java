...
public class TarefaService {
    ...
    public Tarefa importarTarefaDaApi(Long idTarefa) throws IOException, InterruptedException {
        ...
        // Busca o usuário localmente ou cria um usuário fake com ID
        Usuario usuario = usuarioRepository.findById(dto.getUsuarioId())
                .orElseGet(() -> {
                    logger.warn("Usuário com ID {} não encontrado localmente. Usando usuário fake.", dto.getUsuarioId());
                    Usuario u = new Usuario();
                    u.setId(dto.getUsuarioId());
                    u.setNome("Usuário Externo");
                    return u;
                });
